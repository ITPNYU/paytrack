...
invoice_blueprint = manager.create_api(Invoice, methods=['GET', 'DELETE', 'PATCH', 'POST', 'PUT'], collection_name='invoice', url_prefix='/v1', include_methods = ['payer.payments_due'])
